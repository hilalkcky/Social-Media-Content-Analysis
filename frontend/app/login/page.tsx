  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#0b1220] text-white">
      ...
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-10 backdrop-blur-xl">
        ...
        <h1 className="text-4xl font-bold text-center">Giriş Yap</h1>
        ...
        <div className="mt-10 space-y-5">
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="w-full rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 px-8 py-4 font-semibold transition hover:scale-[1.02] disabled:opacity-50"
          >
        ...
        <p className="mt-6 text-center text-sm text-gray-400">
          Hesabın yok mu?{" "}
          <Link href="/register" className="text-blue-400 hover:text-purple-400">
            Kayıt Ol
          </Link>
        </p>
